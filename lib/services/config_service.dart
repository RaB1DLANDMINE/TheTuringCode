  ...
  static Future<File?> _getExternalFile() async {
    if (Platform.isAndroid) {
      if (await Permission.manageExternalStorage.request().isGranted ||
        ...
        // In modern Android, accessing Downloads might require different approaches,
        // but path_provider can give us some directories.
        // For simplicity, we try to find a common download path.
